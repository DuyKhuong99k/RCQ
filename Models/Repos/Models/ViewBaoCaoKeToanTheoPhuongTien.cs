...
[Table("ViewBaoCaoKeToanTheoPhuongTien")] // This is the table name in the database
[Keyless]
public partial class ViewBaoCaoKeToanTheoPhuongTien
{
    ...
    [Column("Cá Mạnh", TypeName = "decimal(18, 2)")]
    public decimal Cá_Mạnh { get; set; }

    [Column("Ngộp Ao Ghe", TypeName = "decimal(18, 2)")]
    public decimal Ngộp_Ao_Ghe { get; set; }

    [Column("Ngộp Ao Xe", TypeName = "decimal(18, 2)")]
    public decimal Ngộp_Ao_Xe { get; set; }

    [Column("Tổng Hầm", TypeName = "decimal(18, 2)")]
