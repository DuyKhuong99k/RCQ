 ...
 */
    ...
    function runup() {
        ...
        jQuery.fn.final_countdown = function (options, callback) {
            element = $(this);
        ...
        function staVCXounters() {
            ...
            var interval = setInterval(function () {
                ...
                if (timer.seconds > 59) {
                    ...
                    if (timer.minutes > 59) {
                        ...
                        if (timer.hours > 23) {
                            ...
                            if (timer.days > 0) {
                                timer.days--;
                                 if(timer.days < 10){
                            $("#day").html("0" + (timer.days).toString());
                        }else{
                           $("#day").html(timer.days);
                        }
                                 $("#day").html(timer.days);
                        ...
                        if(60 - timer.hours < 10){
                            $("#hour").html("0" + (60 - timer.hours).toString());
                        }else{
                           $("#hour").html(60 - timer.hours); 
                        }
                    ...
                    if(60 - timer.minutes < 10){
                            $("#minute").html("0" + (60 - timer.minutes).toString());
                        }else{
                           $("#minute").html(60 - timer.minutes); 
                        }
                    layerMinutes.draw();
                ...
                if(60 - timer.seconds < 10){
                            $("#seconds").html("0" + (60 - timer.seconds).toString());
                        }else{
                           $("#seconds").html(60 - timer.seconds); 
                        }
