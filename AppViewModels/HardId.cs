...
namespace AppViewModels
{
    public class HardId
    {
        ...
        private static string MacId()
        {
            ...
            //        continue;
            //    }
            //    object name = objMO["Name"];
            //    if (macAddress == String.Empty || name.ToString() == "Ethernet") // only return MAC Address from first card that has a MAC Address
            //    {
            ...
            foreach (NetworkInterface nic in NetworkInterface.GetAllNetworkInterfaces())
            {
                ...
                if (nic.NetworkInterfaceType == NetworkInterfaceType.Ethernet &&
                    ...
                    !nic.Description.ToUpper().Contains("VIRTUAL"))
                {
