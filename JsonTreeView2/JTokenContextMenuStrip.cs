...
using JsonTreeView2.Extensions;
using JsonTreeView2.Generic;
using JsonTreeView2.Linq;
using JsonTreeView2.Properties;

namespace JsonTreeView2
{
    public partial class JTokenContextMenuStrip : ContextMenuStrip
    {
        /// <summary>
        ...
        //public JTokenContextMenuStrip(IContainer container)
        //{
        //    container.Add(this);
