  ...
  function (window) {
        ...
        for (var prop in obj) {
          if (Object.prototype.hasOwnProperty.call(obj, prop)) {
            if (
              ...
              extended[prop] = kioskBoardExtendObjects(
                extended[prop],
                obj[prop]
              );
            } else {
    ...
    var KioskBoard = {
      ...
      inits: function () {
           KioskBoard.init({
            keysArrayOfObjects: null,
            keysJsonUrl: '/jsons/kioskboard-keys-english.json',
            keysSpecialCharsArrayOfStrings: null,
            keysNumpadArrayOfNumbers: null,
            language: 'en',
            theme: 'light',
      ...
      run: function (selectorOrElement, options) {
        ...
        // Else: Check the selector is valid for the querySelector
          ...
          var selectorIsValid =
            ...
            selectorOrElement.length > 0;
          if (!selectorIsValid) {
            kioskBoardConsoleError(
              '"' + selectorOrElement + '" is not a valid selector.'
            );
            return false;
          }
        ...
        var createKeyboardAndAppendTo = function (data, input) {
          ...
          var inputFocusListener = function (e) {
            ...
            var allowedSpecialCharacters =
              (
                theInput.dataset.kioskboardSpecialcharacters || ""
              ).toLocaleLowerCase("en") === "true";
            ...
            // all keys styles
            var fontFamily =
              typeof opt.keysFontFamily === "string" &&
              opt.keysFontFamily.length > 0
                ? opt.keysFontFamily
                : "sans-serif";
            var fontSize =
              typeof opt.keysFontSize === "string" &&
              opt.keysFontSize.length > 0
                ? opt.keysFontSize
                : "22px";
            var fontWeight =
              typeof opt.keysFontWeight === "string" &&
              opt.keysFontWeight.length > 0
                ? opt.keysFontWeight
                : "normal";
            ...
            var keysIconWidth =
              typeof opt.keysIconSize === "string" &&
              opt.keysIconSize.length > 0
                ? opt.keysIconSize
                : "25px";
            ...
            var keysSpacebarText =
              typeof opt.keysSpacebarText === "string" &&
              opt.keysSpacebarText.length > 0
                ? opt.keysSpacebarText
                : "Space";
            var keysEnterText =
              typeof opt.keysEnterText === "string" &&
              opt.keysEnterText.length > 0
                ? opt.keysEnterText
                : "Enter";
            ...
            if (allowedSpecialCharacters) {
              ...
              if (
                Array.isArray(specialCharacters) &&
                specialCharacters.length > 0
              ) {
                kioskBoardSpecialCharacters = specialCharacters.reduce(
                  function (scMemo, scKey, scIndex) {
            ...
            kioskBoardVirtualKeyboard.style.webkitLocale =
              '"' + keyboardLanguage + '"';
            ...
            var keysClickListeners = function (input) {
              ...
              var eachKeyElm =
                window.document.querySelectorAll(".kioskboard-key");
              ...
              if (
                ...
                keysEventListeners(specialCharCloseElm, function (e) {
                  e.preventDefault();
                  input.focus(); // focus the input
                  specialCharacterKeyElm.classList.remove(
                    "specialcharacter-active"
                  );
                  specialCharactersRowElm.classList.remove(
                    "kioskboard-specialcharacter-show"
              ...
              var enterKeyElm = window.document.querySelector(
            ...
            if (!keyboardElement) {
              ...
              var documentHeight = Math.round(
                window.document.body.clientHeight
              );
              var keyboardHeight = Math.round(
                window.document.getElementById(kioskBoardVirtualKeyboardId)
                  .offsetHeight
              );
              if (keyboardHeight > Math.round((windowHeight / 3) * 2)) {
                var keyboardWrapper = window.document.querySelector(
                  ".kioskboard-wrapper"
                );
              ...
              var isPlacementTop =
                keyboardPlacement === kioskBoardPlacements.Top;
              ...
              var isPaddingTop =
                theInputOffsetTop < keyboardHeight && isPlacementTop;
              var isPaddingBottom =
                documentHeight <= theInputOffsetTop + keyboardHeight &&
                !isPlacementTop;

              if (isPaddingTop || isPaddingBottom) {
                var styleElm = window.document.getElementById(
                  "KioskboardBodyPadding"
                );
              ...
              if (autoScroll) {
                ...
                var scrollBehavior =
                  opt.cssAnimations === true ? "smooth" : "auto";
                var scrollDelay =
                ...
                var userAgent =
                  window.navigator.userAgent.toLocaleLowerCase("en");
      ...
      runs: function (selectorOrElement) {
          KioskBoard.inits();
          KioskBoard.run(selectorOrElement);
      },
      removeKeyboardInternal: function () {
        // add remove class
        var keyboardElm = window.document.getElementById(
          kioskBoardVirtualKeyboardId
        );
