...
{
    public partial class TKhachHangViewModel : ObservableObject
    {
        private static TKhachHangViewModel instance;
        [ObservableProperty] private bool idItemIsReadOnly = true;
        [ObservableProperty] private bool isAdd;
        [ObservableProperty] private bool isEdit;
        [ObservableProperty] private T_KhachHang? item;
        [ObservableProperty] private ObservableRangeCollection<T_KhachHang> items = new();

        [ObservableProperty][NotifyPropertyChangedFor(nameof(IsVailSelectedItem))] private T_KhachHang? selectedItem;
        [ObservableProperty] private ObservableRangeCollection<object> selectedItems = new();
        [ObservableProperty] private ICommand _closeItemWindowCommand;
        [ObservableProperty] private bool _isWindowItemShown = false;
        private readonly SynchronizationContext synchronizationContext;
        private TKhachHangViewModel()
        {
            try
            {
                Reload();
        ...
        public static TKhachHangViewModel Instance => instance ??= new TKhachHangViewModel();
        ...
        public T_KhachHang? Find(string ma)
        {
            try
            {
        ...
        public bool Exists(T_KhachHang item)
        {
            try
            {
