...
{
    public partial class PhieuCan_DH_XL_ViewModel : ObservableObject
    {
        private static PhieuCan_DH_XL_ViewModel instance;
        ...
        private PhieuCan_DH_XL_ViewModel()
        {
            try
            {
                Reload();
        ...
        public static PhieuCan_DH_XL_ViewModel Instance => instance ??= new PhieuCan_DH_XL_ViewModel();
