...
{
    public partial class AoVungNuoiViewModel : ObservableObject
    {
        private static AoVungNuoiViewModel instance;
        ...
        public static AoVungNuoiViewModel Instance => instance ??= new AoVungNuoiViewModel();
        ...
        public bool Exists(MaAoVungNuoi item)
        {
            try
            {
