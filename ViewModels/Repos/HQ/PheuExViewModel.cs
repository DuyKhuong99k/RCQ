...
{
    public partial class PheuExViewModel : ObservableObject
    {
        private static PheuExViewModel instance;
        ...
        public static PheuExViewModel Instance => instance ??= new PheuExViewModel();
