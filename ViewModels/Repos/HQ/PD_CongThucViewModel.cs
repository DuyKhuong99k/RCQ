...
{
    public partial class PD_CongThucViewModel : ObservableObject
    {
        private static PD_CongThucViewModel instance;
        ...
        public static PD_CongThucViewModel Instance => instance ??= new PD_CongThucViewModel();
        ...
        public bool Exists(PD_CongThuc item)
        {
            try
            {
        ...
        {
            var dao = new Dao.Repos.HQ.PD_CongThuc(connStr);
            return dao.GetsFullField<T>();
        }
        public List<T> GetsFullFieldCongThucChiTiet<T>(string maCongThuc, DateTime ngay ,string? connStr = null)
        {
            var dao = new Dao.Repos.HQ.PD_CongThucChiTiet(connStr);
            return dao.GetsFullField<T>(maCongThuc,ngay);
        }
    }
}
