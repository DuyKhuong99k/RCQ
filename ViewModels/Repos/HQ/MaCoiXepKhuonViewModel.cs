...
{
    public partial class MaCoiXepKhuonViewModel : ObservableObject
    {
        private static MaCoiXepKhuonViewModel instance;
        ...
        [ObservableProperty][NotifyPropertyChangedFor(nameof(IsVailSelectedItem))] private MaCoiXepKhuon? selectedItem;
        [ObservableProperty] private ObservableRangeCollection<object> selectedItems = new();
        [ObservableProperty] private ICommand _closeItemWindowCommand;
        [ObservableProperty] private bool _isWindowItemShown = false;
        private readonly SynchronizationContext synchronizationContext;
        private MaCoiXepKhuonViewModel()
        {
            try
            {
                Reload();
        ...
        public static MaCoiXepKhuonViewModel Instance => instance ??= new MaCoiXepKhuonViewModel();
        ...
        public MaCoiXepKhuon CopySelectedItem()
        {
        ...
        {
            var maxId = Items.Where(x => int.TryParse(x.Ma, out int rl))
            ...
            return new MaCoiXepKhuon()
            {
                //Tam = true, //không rõ, nên không thêm
                Ma = id,
            };
        }
        ...
        public bool Exists(MaCoiXepKhuon item)
        {
            try
            {
