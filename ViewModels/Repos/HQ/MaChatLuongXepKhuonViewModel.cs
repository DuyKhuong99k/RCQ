...
{
    public partial class MaChatLuongXepKhuonViewModel : ObservableObject
    {
        private static MaChatLuongXepKhuonViewModel instance;
        ...
        private MaChatLuongXepKhuonViewModel()
        {
            try
            {
                Reload();
        ...
        public static MaChatLuongXepKhuonViewModel Instance => instance ??= new MaChatLuongXepKhuonViewModel();
        ...
        public bool Exists(MaChatLuongXepKhuon item)
        {
            try
            {
