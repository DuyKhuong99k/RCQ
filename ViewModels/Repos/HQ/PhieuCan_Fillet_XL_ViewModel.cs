...
{
    public partial class PhieuCan_Fillet_XL_ViewModel : ObservableObject
    {
        private static PhieuCan_Fillet_XL_ViewModel instance;
        ...
        private PhieuCan_Fillet_XL_ViewModel()
        {
            try
            {
                Reload();
        ...
        public static PhieuCan_Fillet_XL_ViewModel Instance => instance ??= new PhieuCan_Fillet_XL_ViewModel();
