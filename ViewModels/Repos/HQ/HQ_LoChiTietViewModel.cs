...
{
    public partial class HQ_LoChiTietViewModel: ObservableObject
    {
        private static HQ_LoChiTietViewModel instance;
        ...
        public static HQ_LoChiTietViewModel Instance => instance ??= new HQ_LoChiTietViewModel();
