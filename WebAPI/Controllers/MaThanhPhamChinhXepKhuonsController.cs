...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class MaThanhPhamChinhXepKhuonsController : ControllerBase
    {
        private readonly dbPMScontext _context;

        public MaThanhPhamChinhXepKhuonsController(dbPMScontext context)
        {
            _context = context;
        }
        ...
        {
            var items = _context.MaThanhPhamChinhXepKhuon.OrderByDescending(x => x.Ma).ToList();
        ...
        {
            var item = _context.MaThanhPhamChinhXepKhuon.FirstOrDefault(x => x.Ma == ma);
            if (item == null)
            {
        ...
        [HttpPost]
        [Authorize]
        public async Task<IActionResult> Insert(MaThanhPhamChinhXepKhuon model)
        {
            ...
            if (_context.MaThanhPhamChinhXepKhuon.Any(u => u.Ma == model.Ma))
            {
                return BadRequest(new ApiResponse
                {
                    Success = false,
            ...
            var newItem = new MaThanhPhamChinhXepKhuon
            {
                Ten = model.Ten,
                Ma = model.Ma,
                SuDung = model.SuDung,
        ...
        [HttpPost("{ma}")]
        [Authorize]
        public async Task<IActionResult> Update(string ma, [FromBody] MaThanhPhamChinhXepKhuon model)
        {
            ...
            var item = await _context.MaThanhPhamChinhXepKhuon.FindAsync(ma);
            if (item == null)
            {
                return BadRequest(new ApiResponse
                {
        ...
        public async Task<IActionResult> Delete(string ma)
        {
            ...
            _context.MaThanhPhamChinhXepKhuon.Remove(item);
