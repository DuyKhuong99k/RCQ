...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class HQ_LoaiNguyenLieusController : ControllerBase
    {
        private readonly dbPMScontext _context;

        public HQ_LoaiNguyenLieusController(dbPMScontext context)
        {
            _context = context;
        }
        ...
        {
            var items = _context.HqLoaiNguyenLieus.OrderByDescending(x => x.Id).ToList();
        ...
        {
            var item = _context.HqLoaiNguyenLieus.FirstOrDefault(x => x.Id == id);
            if (item == null)
            {
        ...
        public async Task<IActionResult> Insert(HQ_LoaiNguyenLieu model)
        {
            ...
            if (_context.HqLoaiNguyenLieus.Any(u => u.Id == model.Id))
            {
                return BadRequest(new ApiResponse
                {
                    Success = false,
            ...
            var newItem = new HQ_LoaiNguyenLieu
            {
                Ten = model.Ten,
                Id = model.Id,
                SuDung = model.SuDung,
        ...
        [HttpPost("{id}")]
        [Authorize]
        public async Task<IActionResult> Update(string id, [FromBody] HQ_LoaiNguyenLieu model)
        {
            ...
            var item = await _context.HqLoaiNguyenLieus.FindAsync(id);
            if (item == null)
            {
                return BadRequest(new ApiResponse
                {
            ...
            try
            {
                ...
                var newItemUs = new HQ_LoaiNguyenLieu_U
                {
                ...
                _context.HqLoaiNguyenLieuUs.Add(newItemUs);
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            _context.HqLoaiNguyenLieus.Remove(item);
            ...
            try
            {
                ...
                _context.HqLoaiNguyenLieuDs.Add(newItemUs);
