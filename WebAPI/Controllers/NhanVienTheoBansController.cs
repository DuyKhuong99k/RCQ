...
namespace WebAPI.Controllers
{
    ...
    public class NhanVienTheoBansController : ControllerBase
    {
        ...
        [HttpGet("{maBan}/{maXuong}")]
        [Authorize]
        public IActionResult GetNhanVienTheoBansMoiNhat(string maBan, string maXuong)
        {
            var items = Vm.VmNhanVienTheoban.GetNhanVienTheoBansMoiNhat<object>(maBan, maXuong, _context.Database.GetConnectionString());
            return Ok(items);
        }
        [HttpGet]
        [Authorize]
