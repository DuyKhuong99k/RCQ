...
{
    public partial class PhieuCanCaGiong
    {
        private readonly string connectionString;
        private readonly string queryGetsByDate = @"Select * from PhieuCanCaGiong Where Ngay = @ngay";
        private readonly string queryDeleteByDate = @"DELETE FROM [dbo].[PhieuCanCaGiong]
      WHERE  [Ngay] = @ngay";
        public PhieuCanCaGiong(string? _connectionString = null)
        {
